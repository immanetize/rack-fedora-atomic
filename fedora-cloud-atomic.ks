...
ostree remote add --set=gpg-verify=false fedora-atomic 'https://repo.randomuser.org/repo/ostree/'
...
echo 'GROWPART=true VG=docker' > /etc/sysconfig/docker-storage-setup
